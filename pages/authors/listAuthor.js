        ...
        <>
            ...
            <Navbar/>  
                <Box bgColor={'#435d7d'} height={'3em'}>
                    <Heading as="h1" paddingLeft={'0.5em'} color="#fff">Liste des auteurs</Heading>
                </Box>
                <Button m={'1em 0'} backgroundColor={'#435d7d'} _hover={'none'}>
                    <NextLink href='/authors/createAuthor'>
                        <Link color={'#fff'} style={{ textDecoration: 'none'}}>
                            <FontAwesomeIcon icon={faPlus} /> Ajouter un auteur  
                        </Link>
                    </NextLink>
                </Button>
                        ...
                        <Tr key={author.Id}>
                            ...
                            <Td>
                                ...
                                <NextLink href={`/authors/listAuthor`}>
                                        <Link onClick={(e) => deleteAuthor(author.Id)} color={'#fff'} style={{ textDecoration: 'none'}}>
